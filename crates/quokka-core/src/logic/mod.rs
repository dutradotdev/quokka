//! Pure domain logic shared by the CLI renderers, `--json`, and the GUI:
//! analyze heuristics, media aggregations, and the size ranking below. No
//! device, no terminal — the commands in `crate::commands` consume these.
